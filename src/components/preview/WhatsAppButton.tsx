...
const WhatsAppButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="sticky bottom-4 left-full -ml-24 w-14 h-14 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 z-50 p-3"
