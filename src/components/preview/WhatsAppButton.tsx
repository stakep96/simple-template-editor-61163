...
const WhatsAppButton = () => {
  ...
  return (
    <button
      onClick={handleClick}
      className="absolute bottom-5 right-5 w-16 h-16 bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full shadow-lg flex items-center justify-center transition-all duration-300 hover:scale-110 z-50 p-3"
