  ...
  moduleInstances: {
    ...
    'practice-1': {
      ...
      config: {
        enabled: true,
        areas: [
          { id: '1', title: 'Direito Criminal', icon: 'baton' },
          { id: '2', title: 'Direito Empresarial', icon: 'briefcase' },
          { id: '3', title: 'Direito Imobiliário', icon: 'contract' },
          { id: '4', title: 'Direito da Família', icon: 'lawyer' },
          { id: '5', title: 'Defesa do Consumidor', icon: 'balance' },
          { id: '6', title: 'Direito Trabalhista', icon: 'law' },
        ],
